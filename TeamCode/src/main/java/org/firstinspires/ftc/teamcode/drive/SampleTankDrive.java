...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "ch1");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "ch2");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "ch3");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "ch0");
